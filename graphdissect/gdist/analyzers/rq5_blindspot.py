...
def _import_nx():
    try:
        ...
        raise RuntimeError("RQ5RegionImbalance requires networkx (`pip install networkx`).") from e
    return nx
...
# RQ5 Analyzer
# -----------------------------
class RQ5RegionImbalance(Analyzer):
    """
    Computes:
    ...
    """
    key = "rq5_region_imbalance"
    description = "RQ5: Region-level imbalance under multi-driver fuzzing (SNDP + community regions)"
